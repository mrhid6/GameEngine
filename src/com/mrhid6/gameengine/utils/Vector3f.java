  ...
  implements  Cloneable, Serializable
{
  ...
  public static final Vector3f NAN = new Vector3f((0.0F / 0.0F), (0.0F / 0.0F), (0.0F / 0.0F));
  ...
  public static final Vector3f POSITIVE_INFINITY = new Vector3f((1.0F / 1.0F), (1.0F / 1.0F), (1.0F / 1.0F));

  public static final Vector3f NEGATIVE_INFINITY = new Vector3f((1.0F / -1.0F), (1.0F / -1.0F), (1.0F / -1.0F));
  public float x;
  public float y;
  public float z;
  ...
  public static void generateComplementBasis(Vector3f u, Vector3f v, Vector3f w)
  {
    ...
    {
      float fInvLength = (float)(1.0D /Math.sqrt(w.x * w.x + w.z * w.z));
      u.x = (-w.z * fInvLength);
      u.y = 0.0F;
      u.z = (w.x * fInvLength);
      v.x = (w.y * u.z);
      ...
      float fInvLength = (float)(1.0D /Math.sqrt(w.y * w.y + w.z * w.z));
      u.x = 0.0F;
      u.y = (w.z * fInvLength);
      u.z = (-w.y * fInvLength);
      v.x = (w.y * u.z - w.z * u.y);
  ...
  {
    try {
      return (Vector3f)super.clone(); } catch (CloneNotSupportedException e) {
    }
