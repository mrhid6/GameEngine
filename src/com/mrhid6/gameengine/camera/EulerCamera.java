...
import com.mrhid6.gameengine.Input;
...
public final class EulerCamera implements Camera {
    ...
    /**
     * Processes Input input and converts into camera movement.
     *
	...
	public void processKeyboard(float delta) {
        ...
        boolean keyUp = Input.getKey(Input.KEY_UP) || Input.getKey(Input.KEY_W);
        boolean keyDown = Input.getKey(Input.KEY_DOWN) || Input.getKey(Input.KEY_S);
        boolean keyLeft = Input.getKey(Input.KEY_LEFT) || Input.getKey(Input.KEY_A);
        boolean keyRight = Input.getKey(Input.KEY_RIGHT) || Input.getKey(Input.KEY_D);
        boolean flyUp = Input.getKey(Input.KEY_SPACE);
        boolean flyDown = Input.getKey(Input.KEY_LSHIFT);
